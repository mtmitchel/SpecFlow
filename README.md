...
- **Execution board handoff**: Tickets now keeps phase context visible while opening the selected phase as a status-based kanban board, so board work leads straight into execution.
